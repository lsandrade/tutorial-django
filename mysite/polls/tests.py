...
class QuestionMethodTests(TestCase):
    ...
    def test_was_punlished_recently_with_old_question(self):
        """
        was_published_recently() should return False for questions
...
def create_question(question_text, days):
        ...
        (negative for questions published in te past, positive
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in the past shoud be displayed
        on the index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    def test_details_view_with_a_future_question(self):
        """
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date in the
        past should display the question's text.
        """
